        ...
        <div>
          <form className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input placeholder="e.g. Stephen King" className="border p-1 rounded-md"/>
            </div>

            <div className="flex flex-col gap-1">
              <label className="text-blue-900 font-semibold">Email Address</label>
              <input placeholder="e.g. stephenking@lorem.com" className="border p-1 rounded-md" />
            </div>

            <div className="flex flex-col gap-1">
              <label className="text-blue-900 font-semibold">Phone Number</label>
              <input placeholder="e.g. +1 234 567 890" className="border p-1 rounded-md"/>
            </div>
          </form>
        </div>
      </div>
